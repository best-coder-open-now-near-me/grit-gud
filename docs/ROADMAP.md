...
not imply permanent full-match replay storage. Playback stays anchored to that
character while retaining ordinary camera controls, and their previous-turn
